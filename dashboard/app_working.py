...
Simple, working version with all tabs functional
"""
...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'simple-' + secrets.token_hex(16))
...
class User:
    def __init__(self, user_id, email, password_hash):
        ...
        self.profiles = [
            {'username': 'ourviralpicks', 'niche': 'Home & Lifestyle', 'profit': 12412, 'growth': 24.7, 'fyp_score': 95, 'status': 'active'},
            {'username': 'homegadgetfinds', 'niche': 'Gadgets & Tech', 'profit': 8923, 'growth': 18.2, 'fyp_score': 88, 'status': 'active'},
            {'username': 'beautytrends', 'niche': 'Beauty & Skincare', 'profit': 15678, 'growth': 32.1, 'fyp_score': 92, 'status': 'active'},
            {'username': 'cartcravings30', 'niche': 'Food & Kitchen', 'profit': 5842, 'growth': 8.3, 'fyp_score': 72, 'status': 'warning'},
            {'username': 'fitnessessentials', 'niche': 'Fitness & Wellness', 'profit': 10234, 'growth': 21.5, 'fyp_score': 89, 'status': 'active'}
        ]
...
def api_login():
    ...
    sessions[token] = {'user_id': user.id, 'expires': datetime.now()}
...
def dashboard():
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1.5rem; margin-bottom: 2rem;">
        <div class="card">
            ...
            <div style="font-size: 2rem; font-weight: 800; color: var(--cyan);">${total_gmv:,}</div>
        ...
        <div class="card">
            ...
            <div style="font-size: 2rem; font-weight: 800; color: var(--cyan);">${commission_earned:,}</div>
            <div style="color: #10b981; font-size: 0.85rem; margin-top: 0.5rem;">
        ...
        <div class="card">
            ...
            <div style="font-size: 2rem; font-weight: 800; color: var(--cyan);">{len(user.profiles)}</div>
            <div style="color: #10b981; font-size: 0.85rem; margin-top: 0.5rem;">
